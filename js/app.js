...
let thing = new CartItem(product,quantity);
...
//   let cartStorage = Cart.thing;
//  let savedStorage = JSON.stringify(cartStorage);
//   localStorage.setItem('cartStorage',savedStorage) ;
};
